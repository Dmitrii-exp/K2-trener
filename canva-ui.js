(() => {
  ...
  const css = `
    ...
    .shell:has(.cold-call-portrait){display:block!important;min-height:100vh!important}.shell:has(.cold-call-portrait) .side{display:none!important}.shell:has(.cold-call-portrait) .content{max-width:none!important;padding:0!important;margin:0!important;width:100%!important}.cold-call-stage{min-height:100vh;display:flex;align-items:center;justify-content:center;background:#07163a;padding:20px;box-sizing:border-box}.cold-call-portrait{position:relative;width:min(430px,100%);height:min(760px,calc(100vh - 40px));min-height:640px;aspect-ratio:430/760;overflow:hidden;border-radius:36px;background:radial-gradient(circle at 22% 28%,rgba(20,190,185,.42),transparent 34%),radial-gradient(circle at 78% 36%,rgba(80,72,255,.48),transparent 38%),linear-gradient(145deg,#06336e 0%,#086ea7 28%,#063d87 58%,#152f9c 82%,#321b75 100%);box-shadow:0 30px 80px rgba(0,0,0,.32);color:#fff;font-family:Inter,ui-sans-serif,Arial,sans-serif}.cold-call-portrait:before{content:"";position:absolute;inset:-20%;background:radial-gradient(circle at 50% 42%,rgba(43,157,255,.22),transparent 32%);filter:blur(28px);pointer-events:none}.cold-call-name{position:absolute;top:17%;left:0;right:0;text-align:center;font-size:43px;line-height:1.05;font-weight:750;letter-spacing:-1.5px}.cold-call-timer{position:absolute;top:25%;left:0;right:0;text-align:center;font-size:26px;line-height:1;font-weight:500;color:rgba(255,255,255,.72);font-variant-numeric:tabular-nums}.cold-call-controls{position:absolute;left:8%;right:8%;bottom:11%;display:grid;grid-template-columns:repeat(3,1fr);align-items:start;gap:12px}.cold-call-control{display:flex;flex-direction:column;align-items:center;gap:11px;border:0;background:none;color:#fff;font:inherit;cursor:pointer;padding:0}.cold-call-control-circle{width:112px;height:112px;border-radius:50%;display:grid;place-items:center;background:rgba(34,104,155,.38);border:1.5px solid rgba(151,230,255,.78);box-shadow:inset 0 1px 10px rgba(255,255,255,.08),0 8px 24px rgba(0,0,0,.12);box-sizing:border-box}.cold-call-control svg{width:45px;height:45px}.cold-call-control span{font-size:16px;font-weight:500;white-space:nowrap}.cold-call-control.end .cold-call-control-circle{width:116px;height:116px;background:#f21d21;border-color:rgba(255,255,255,.2);box-shadow:0 10px 26px rgba(240,20,30,.28),inset 0 1px 2px rgba(255,255,255,.2)}.cold-call-control.end:hover .cold-call-control-circle{background:#dc1519;transform:scale(1.03)}.cold-call-control:hover:not(.end) .cold-call-control-circle{background:rgba(42,123,183,.48);transform:scale(1.02)}.cold-call-end-note{position:absolute;left:0;right:0;bottom:4%;text-align:center;color:rgba(255,255,255,.48);font-size:10px}

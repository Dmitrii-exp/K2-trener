...
(function(){
  ...
  function styles(){
    ...
    s.textContent=`
      ...
      .st-text-modal{width:min(960px,96vw);height:min(780px,92vh);background:#fff;border:1px solid #e4e1ed;border-radius:26px;box-shadow:0 35px 110px rgba(18,12,45,.3);display:grid;grid-template-rows:auto minmax(0,1fr) auto auto auto;overflow:hidden}
      ...
      .st-text-messages{min-height:0;padding:26px;overflow:auto;background:#faf9ff}.st-text-row{display:flex;margin:12px 0}.st-text-row.manager{justify-content:flex-end}.st-text-bubble{max-width:76%;padding:14px 17px;border-radius:18px;border:1px solid #e4e2eb;background:#fff;line-height:1.5;font-size:15px;box-shadow:0 3px 12px rgba(30,20,70,.025)}.st-text-row.manager .st-text-bubble{background:#eeeaff;border-color:#ddd5ff}.st-text-name{font-size:11px;font-weight:850;color:#7357ff;margin-bottom:5px}.st-text-empty{text-align:center;padding:70px 20px;color:#85889a}
